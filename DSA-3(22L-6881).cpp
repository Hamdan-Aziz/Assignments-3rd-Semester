...
//		{
//			capacity = capacity * 2;
//			heapItem* newArray = new heapItem[capacity];
...
//			while (itr1 != itr2)
//			{
//				Queue.decreaseKey((*itr1).id, (*itr1).time + (*obj).time);
//				itr1++;
//			}
//		}
//	}
...
public:
	...
	void FindOptimalRoutes()
	{
		...
		for (int i = 0; i < total; i++)
		{
			...
			cout << arr[i].id << " <-- ";
			//cout << "Time Taken :" << arr[i].time << endl;*/
			/*cout << "Previous :" << endl;*/
			cout << arr[i].prev;
			for (int j = 0;j < 5; j++)
			{
